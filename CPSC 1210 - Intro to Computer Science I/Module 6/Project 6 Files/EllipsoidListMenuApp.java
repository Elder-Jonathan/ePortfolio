...
/**
* Project 6 Part 3 CPSC 1210 Intro to Computer Science.
* @author Jonathan Elder Date: 7/4/2022
*/
public class EllipsoidListMenuApp {
/*
* Creating a Scanner class object which is used based on user input.
* 
*/
      ...
      while (true) {
         ...
         switch (choice) {
            ...
            case 'p':
               ...
               ArrayList<Ellipsoid> list = el.getList();
