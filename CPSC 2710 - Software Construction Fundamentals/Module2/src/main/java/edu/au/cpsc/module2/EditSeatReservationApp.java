...
public class EditSeatReservationApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Default number of passengers is 1. If flying with an infant, update below.
        seatReservation.setNumberOfPassengers(1);
        seatReservation.makeFlyingWithInfant();
        // Update the number of passengers accordingly if an infant is flying.
        if (seatReservation.isFlyingWithInfant()) {
            seatReservation.setNumberOfPassengers(2);
        }
        ...
        saveButton.setOnAction(event -> {
            try {
                ...
                seatReservation.setNumberOfPassengers(Integer.parseInt(numberOfPassengers.getText()));
                if (flyingWithInfantCheckBox.isSelected()) {
                    seatReservation.makeFlyingWithInfant();
                } else {
        ...
        // Initialize the UI controls with the SeatReservation's current data.
        updateUI();
    ...
    /**
     * Updates the UI fields with the values from the seatReservation object.
     */
    private void updateUI() {
        ...
        numberOfPassengers.setText(String.valueOf(seatReservation.getNumberOfPassengers()));
