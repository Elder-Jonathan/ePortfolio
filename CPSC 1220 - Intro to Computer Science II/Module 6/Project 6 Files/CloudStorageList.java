...
public class CloudStorageList {
   ...
   /**
    * Reads cloud storage data from a specified file and processes each line, creating appropriate CloudStorage objects based on types.
    ...
    * @return A formatted string containing CloudStorage objects in a report sorted by name.
    */
    ...
    * @return A formatted string containing CloudStorage objecst in a report sorted by monthly cost.
    */
   ...
   /**
    * Generates a formatted report of invalid records.
    * @return A formatted string containing all invalid records.
    */
   public String generateInvalidRecordsReport() {
      StringBuilder report = new StringBuilder();
      report.append("-------------------------------------------------\n")
            .append("Invalid Records Report\n")
            .append("-------------------------------------------------\n");
